            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control" id="supplier_kode" name="supplier_kode"
                        value="{{ old('supplier_kode') }}" required placeholder="Contoh: SUP001">
                    @error('supplier_kode')
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control" id="supplier_nama" name="supplier_nama"
                        value="{{ old('supplier_nama') }}" required placeholder="Masukkan nama supplier">
                    @error('supplier_nama')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <textarea class="form-control" id="supplier_alamat" name="supplier_alamat"
                        rows="3" placeholder="Masukkan alamat supplier (opsional)">{{ old('supplier_alamat') }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control" id="supplier_telp" name="supplier_telp"
                        value="{{ old('supplier_telp') }}" placeholder="Contoh: 0341-123456 (opsional)">
                    @error('supplier_telp')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
